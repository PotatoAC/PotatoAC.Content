...
VALUES (1910202,   1,   33556426) /* Setup */
     ...
     , (1910202,  35,        1000) /* DeathTreasureType - Loot Tier: 7 */;
...
VALUES (1910202,   1,   22000, 0, 0, 22000) /* MaxHealth */
     , (1910202,   3,   8000, 0, 0, 8000) /* MaxStamina */
     , (1910202,   5,   10000, 0, 0, 10000) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (1910202,  6, 0, 3, 0, 280, 0, 1982.44181784858) /* MeleeDefense        Specialized */
     , (1910202,  7, 0, 3, 0, 358, 0, 1982.44181784858) /* MissileDefense      Specialized */
     , (1910202, 13, 0, 3, 0, 350, 0, 1982.44181784858) /* UnarmedCombat       Specialized */
     , (1910202, 14, 0, 2, 0, 300, 0, 1982.44181784858) /* ArcaneLore          Trained */
     , (1910202, 15, 0, 3, 0, 150, 0, 1982.44181784858) /* MagicDefense        Specialized */
     ...
     , (1910202, 34, 0, 3, 0, 15, 0, 1982.44181784858) /* WarMagic            Specialized */;
...
VALUES (1910202,  0,  4,  0,    0,  400,  480,  440,  360,  480,  560,  440,  560,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (1910202,  5,  4, 180, 0.55,  400,  480,  440,  360,  480,  560,  440,  560,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (1910202,  8,  4, 150, 0.55,  400,  480,  440,  360,  480,  560,  440,  560,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (1910202,  1161,   2.02)  /* Heal Self VI */
     , (1910202,  4312,   2.05)  /* Incantation Imperil */
...
VALUES (1910202, 9,  6353,  0, 0, 0.14, False) /* Create Pyreal Mote (6353) for ContainTreasure */
     , (1910202, 9,     0,  0, 0, 0.86, False) /* Create nothing for ContainTreasure */
     , (1910202, 9,  34277,  0, 0, 0.25, False) /* Create Falatcot Trinket for ContainTreasure */
     , (1910202, 9,     0,  0, 0, 0.75, False) /* Create nothing for ContainTreasure */
     , (1910202, 9,  44469,  0, 0, 0.1, False) /* Create Lesser Corrupted Essence for ContainTreasure */
     , (1910202, 9,     0,  0, 0, 0.9, False) /* Create nothing for ContainTreasure */;
