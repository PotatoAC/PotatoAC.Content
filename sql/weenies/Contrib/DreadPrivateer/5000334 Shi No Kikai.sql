...
VALUES (5000334,   1,   33561248) /* Setup */
     ...
     , (5000334,  35,       2000) /* DeathTreasureType - Loot Tier: 7 */;

INSERT INTO `weenie_properties_attribute` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`)
VALUES (5000334,   1, 650, 0, 0) /* Strength */
     , (5000334,   2, 650, 0, 0) /* Endurance */
     , (5000334,   3, 650, 0, 0) /* Quickness */
     , (5000334,   4, 650, 0, 0) /* Coordination */
     , (5000334,   5, 650, 0, 0) /* Focus */
     , (5000334,   6, 650, 0, 0) /* Self */;

INSERT INTO `weenie_properties_attribute_2nd` (`object_Id`, `type`, `init_Level`, `level_From_C_P`, `c_P_Spent`, `current_Level`)
VALUES (5000334,   1, 75000, 0, 0, 75000) /* MaxHealth */
     , (5000334,   3, 50000, 0, 0, 50000) /* MaxStamina */
     , (5000334,   5, 125000, 0, 0, 125000) /* MaxMana */;

INSERT INTO `weenie_properties_skill` (`object_Id`, `type`, `level_From_P_P`, `s_a_c`, `p_p`, `init_Level`, `resistance_At_Last_Check`, `last_Used_Time`)
VALUES (5000334,  6, 0, 3, 0, 380, 0, 0) /* MeleeDefense        Specialized */
     , (5000334,  7, 0, 3, 0, 475, 0, 0) /* MissileDefense      Specialized */
     , (5000334, 14, 0, 3, 0, 200, 0, 1198.474609375) /* ArcaneLore          Specialized */
     , (5000334, 15, 0, 3, 0, 275, 0, 0) /* MagicDefense        Specialized */
     ...
     , (5000334, 47, 0, 3, 0, 9000, 0, 0) /* MissileWeapons      Specialized */
     , (5000334, 49, 0, 3, 0, 9000, 0, 0) /* DualWield           Specialized */;
...
VALUES (5000334,  0,  4,  0,    0, 9000, 1800, 1800, 1800, 1800, 1800, 1800, 1800,    0, 1, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0, 0.33,    0,    0) /* Head */
     ...
     , (5000334,  5,  8, 1000, 0.15, 9000, 1800, 1800, 1800, 1800, 1800, 1800, 1800,    0, 2,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0,    0,  0.2,    0) /* Hand */
     ...
     , (5000334,  8,  8, 1000, 0.15, 9000, 1800, 1800, 1800, 1800, 1800, 1800, 1800,    0, 3,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22,    0,    0, 0.22) /* Foot */;

INSERT INTO `weenie_properties_spell_book` (`object_Id`, `spell`, `probability`)
VALUES (5000334,  1658,    1.5)  /* Stamina to Health Other I */
     , (5000334,  2371,   2.19)  /* Curse of Mortal Flesh */
     , (5000334,  2673,    2.2)  /* Ring of Unspeakable Agony */
     , (5000334,  2674,    2.2)  /* Vicious Rebuke */
     , (5000334,  2697,    1.8)  /* Aerfalle's Touch */
     , (5000334,  2698,    1.8)  /* Aerfalle's Embrace */
     , (5000334,  3053,    1.8)  /* Paralyzing Touch */
     , (5000334,  3111,    2.2)  /* Soul Hammer */
     , (5000334,  3461,   2.19)  /* Batter Flesh */
     , (5000334,  3936,   2.21)  /* Fire Bomb */
     , (5000334,  4312,   2.19)  /* Incantation of Imperil Other */
     ...
     , (5000334,  5582,    1.6)  /* Nullify All Rares */;
...
VALUES (5000334, 2, 46345,  1, 93, 0.4, True) /* Create O-Yoroi Leggings (46345) for Wield */
     ...
     , (5000334, 9, 5000394,  0, 0, 0.2, True) /* Create  (5000394) for ContainTreasure */
     , (5000334, 9, 5000507,  0, 0, 0.2, True) /* Create  (5000507) for ContainTreasure */;
